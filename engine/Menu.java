...
public class Menu {
                ...
                if(optionAUX == 1){
                    for(User user:dataBase.getUserList()){
                        if(user.equals(userOnline)){
                            String email = input.getEmail(true);
                            user.setEmail(email);
                    ...
                    for(User user:dataBase.getUserList()){
                        if(user.equals(userOnline)){
                            String password = input.getPassword(true);
    ...
    private void consultArea(Date dataBase){
        ...
        switch(option){
            case 1:
                String nameCaseOne = input.nameUser(0);
                String nameLastCaseOne = input.lastNameUser();
                ...
                break;
            case 2:
                String nameProject = input.sourceProjects(0);
    ...
    private void paymentArea(Date dataBase){
        ...
        for(Project pj: dataBase.getProjectList()){
            if(pj.getIdProject().equals(nameProject)){
                String nameUser = input.nameUser(0);
                String nameLastUser = input.lastNameUser();
                boolean controlCaseOne = true;
                        ...
                        if(p.getIdProject().equals(nameProject) && p.getCoordinator().equals(userOnline)){
                            ...
                            switch(opCaseTwo){
                                ...
                                case 5:
                                    ...
                                    String firstName = input.lastNameUser();
                                ...
                                case 6:
                                    ...
                                    String firstNm = input.lastNameUser();
                                ...
                                case 7:
                                    ...
                                    String firstNameUser = input.lastNameUser();
